...
const migrateData = async () => {
  try {
    ...
    for (const conversation of conversations) {
      ...
      if (
        summary.theirValues &&
        Array.isArray(summary.theirValues) &&
      ...
      if (
        summary.theirInterests &&
        Array.isArray(summary.theirInterests) &&
      ...
      if (
        ...
        Array.isArray(summary.importantDates) &&
      ...
      if (updated) {
        ...
        console.log(
          `Updated relationship ${relationship._id} with data from conversation ${conversation._id}`
        );
      }
    }
