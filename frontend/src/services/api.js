...
export const relationshipService = {
  ...
  importChat: (relationshipId, formData) =>
    importService.importChat(relationshipId, formData),
...
export const relationshipAnalysisService = {
  ...
  refreshAfterImport: async (relationshipId) => {
    try {
      ...
      console.log(
        "Reached maximum polling attempts, triggering manual analysis"
      );
...
export const conversationService = {
  getAll: (relationshipId) =>
    api.get(`/relationships/${relationshipId}/conversations`),
  getById: (id) => api.get(`/conversations/${id}`),
  create: (relationshipId, data) =>
    api.post(`/relationships/${relationshipId}/conversations`, data),
  ...
  getSummary: (conversationId) =>
    api.get(`/conversations/${conversationId}/summary`),
...
export const voiceService = {
  startRecording: (conversationId) =>
    api.post(`/conversations/${conversationId}/record/start`),
  ...
  getTranscript: (recordingId) =>
    api.get(`/recordings/${recordingId}/transcript`),
};
