...
const ImportChat = () => {
  ...
  const forceUpdateRelationshipMetrics = async () => {
    try {
      console.log(
        "Forcing update of relationship metrics for:",
        relationshipId
      );
      ...
      console.log(
        "Successfully forced relationship metrics update",
        response.data
      );
  ...
  const processTopicsForRelationship = async (topTopics) => {
    try {
      ...
      if (metricsUpdated) {
        ...
        console.log(
          "Topics and metrics successfully updated for relationship:",
          relationshipId
        );
      } else {
  ...
  const getEstimatedTimeRemaining = () => {
    ...
    if (importStats && importStats.messageCount) {
      ...
      const remainingMessages =
        importStats.messageCount * (1 - processedPercent);
            ...
            <Box mt={3}>
              ...
              >
                {chatSource === "whatsapp" ? (
                  ...
                  <>
                    1. On your Mac, export your iMessage conversation
                    <br />
                    2. You can use apps like iMazing or create a CSV with your
                    messages
                    <br />
                  ...
                  <>
                    ...
                    <br />
                    3. Click on the conversation name {">"} Export chat
                    <br />
                    4. Save the file and upload it here
                  </>
                ) : (
                  <>
                    Upload a CSV or text file with your chat history.
                    <br />
                    Format should include: timestamp, sender, and message
                    content.
                    <br />
          ...
          <Box mt={3}>
            {!file ? (
              ...
              <Box
                ...
                borderRadius={2}
                borderColor={
                  darkMode ? "rgba(74, 222, 128, 0.4)" : "success.main"
                }
                p={3}
                mb={3}
                sx={{
              ...
              >
                ...
                <Box display="flex" alignItems="center" mb={2}>
                  ...
                  <Typography
                    variant="h6"
                    fontWeight="600"
                    sx={{ color: darkMode ? "#4ade80" : "success.main" }}
                  >
        ...
        return (
          <Box mt={3}>
            <Typography
              variant="h6"
              gutterBottom
              sx={{ color: darkMode ? "#fff" : undefined, mb: 2 }}
            >
              Processing Import
            </Typography>
            ...
            <Alert
              ...
              sx={{
                mb: 3,
                backgroundColor: darkMode ? "rgba(3, 45, 96, 0.3)" : undefined,
              }}
            >
              <Typography
                variant="body1"
                sx={{ color: darkMode ? "#fff" : undefined }}
              >
                We're importing your {chatSource} chat history and analyzing it
                to generate relationship insights.
              </Typography>
              <Typography
                variant="body2"
                color={darkMode ? "rgba(255, 255, 255, 0.7)" : "text.secondary"}
                sx={{ mt: 1 }}
              >
                This process analyzes message patterns, identifies key topics,
                and extracts valuable relationship insights.
              </Typography>
            </Alert>
          ...
          <Box mt={3}>
            <Box textAlign="center" mb={4}>
              ...
              <Typography
                ...
                sx={{ color: darkMode ? "#fff" : undefined }}
              >
                Successfully imported {importStats?.messageCount || "your"}{" "}
                messages
                {importAnalysis?.timeRange
                  ? ` spanning ${importAnalysis.timeRange}`
                  : ""}
                .
              </Typography>
              {topicsProcessed && (
            ...
            {importAnalysis ? (
              <>
                ...
                >
                  ...
                  >
                    ...
                    {importAnalysis.topSenders &&
                    Object.entries(importAnalysis.topSenders).length > 0 ? (
                      Object.entries(importAnalysis.topSenders).map(
                        ([sender, count], index) => (
                          <Box key={index} mb={2}>
                            <Box
                              display="flex"
                  ...
                  >
                    ...
                    {importAnalysis.topTopics &&
                    importAnalysis.topTopics.length > 0 ? (
                ...
                >
                  ...
                  <Typography
                    ...
                    sx={{ color: darkMode ? "#fff" : undefined }}
                  >
                    {importAnalysis.insights ||
                      "Analysis in progress. Check back shortly for relationship insights."}
                  </Typography>

                  {importAnalysis.summary &&
                    importAnalysis.summary.keyInsights &&
                    importAnalysis.summary.keyInsights.length > 0 && (
                      <>
                        <Divider
                          sx={{
                            my: 2,
                        ...
                        <Box component="ul" sx={{ mt: 1, pl: 2 }}>
                          {importAnalysis.summary.keyInsights.map(
                            (insight, idx) => (
                              <Typography
                                component="li"
                                variant="body2"
                  ...
                  {importAnalysis.summary &&
                    importAnalysis.summary.emotionalDynamics && (
                      <>
                        <Divider
                          sx={{
                            my: 2,
                        ...
                        >
                          ...
                          >
                            ...
                            {importAnalysis.summary.emotionalDynamics.overall ||
                              "Balanced"}
                          </Typography>
                          <Typography
                            variant="body2"
                          ...
                          >
                            ...
                            {importAnalysis.summary.emotionalDynamics.user ||
                              "Engaged"}
                          </Typography>
                          <Typography
                            variant="body2"
                            sx={{ color: darkMode ? "#fff" : undefined }}
                          >
                            <strong>Their Style:</strong>{" "}
                            {importAnalysis.summary.emotionalDynamics.contact ||
                              "Responsive"}
                          </Typography>
                          <Typography
                            variant="body2"
                          ...
                          >
                            ...
                            {importAnalysis.summary.emotionalDynamics.trends ||
                              "Consistent"}
                          </Typography>
                        </Box>
                      </>
                  ...
                  {importAnalysis.summary &&
                    importAnalysis.summary.areasForGrowth &&
                    importAnalysis.summary.areasForGrowth.length > 0 && (
                      <>
                        <Divider
                          sx={{
                            my: 2,
                        ...
                        <Box component="ul" sx={{ mt: 1, pl: 2 }}>
                          {importAnalysis.summary.areasForGrowth.map(
                            (area, idx) => (
                              <Typography
                                component="li"
                                variant="body2"
                ...
                <Box sx={{ mb: 4 }}>
                              ...
                              sx={{
                                ...
                                width: `${
                                  ...
                                  "Balanced"
                                    ...
                                    ? "60%"
                                    : importAnalysis.communicationBalance ===
                                      "You lead significantly"
                                    ? "70%"
                                    : importAnalysis.communicationBalance ===
                                      "They lead slightly"
                                    ? "40%"
                                    : importAnalysis.communicationBalance ===
                                      "They lead significantly"
                                    ? "30%"
                                    : "50%"
                                }`,
                                backgroundColor: darkMode
                  ...
                  {/* Communication Style */}
                  {importAnalysis?.communicationStyle &&
                    Object.keys(importAnalysis.communicationStyle).length >
                      0 && (
                      <Paper
                        variant="outlined"
                        sx={{
                  ...
                  {/* Challenges & Badges */}
                  {importAnalysis?.challengesBadges &&
                    importAnalysis.challengesBadges.length > 0 && (
                      <Paper
                        variant="outlined"
                        sx={{
                          p: 3,
                      ...
                      >
                        ...
                        <Box
                          ...
                          mt={2}
                        >
                          {importAnalysis.challengesBadges.map(
                            (badge, index) => (
                              <Box
                                key={index}
                                sx={{
                ...
                {/* Primary Topics */}
                {importAnalysis?.primaryTopics &&
                  importAnalysis.primaryTopics.length > 0 && (
                    <Paper
                      variant="outlined"
                      sx={{
                        p: 3,
                    ...
                    >
                      ...
                      {importAnalysis?.topicDistribution &&
                        importAnalysis.topicDistribution.length > 0 && (
                          <Box mt={1}>
                            {importAnalysis.topicDistribution.map(
                              (topic, index) => (
                                <Box key={index} mb={2}>
                                  <Box
                                    display="flex"
                                  ...
                                  >
                                    ...
                                    >
                                      {typeof topic.percentage === "number"
                                        ? `${topic.percentage}%`
                                        : typeof topic.percentage === "string"
                                        ? topic.percentage
                                  ...
                                  <LinearProgress
                                    ...
                                    value={
                                      typeof topic.percentage === "number"
                                        ? topic.percentage
                                        : typeof topic.percentage ===
                                            "string" &&
                                          !isNaN(parseFloat(topic.percentage))
                                        ? parseFloat(topic.percentage)
                                        : typeof topic.value === "number"
                                        ? topic.value
                                        : typeof topic.value === "string" &&
                                          !isNaN(parseFloat(topic.value))
                                        ? parseFloat(topic.value)
                                        : 0
                                    }
                                    sx={{
                                      height: 6,
              ...
              >
                <CircularProgress
                  size={40}
                  sx={{ color: darkMode ? "#6366f1" : undefined }}
                />
                <Typography
                  variant="body2"
                  color={
