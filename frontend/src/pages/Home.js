...
const WelcomeDialog = ({ open, onClose, darkMode }) => {
  ...
  const powerDynamics = [
    {
      label: "You initiate conversations",
      value: "85%",
      icon: <ChatBubbleOutlineIcon />,
    },
    {
      label: "You apologize more often",
      value: "2x",
            ...
            >
              <Box
                sx={{
                  ...
                  mx: "auto",
                  animation:
                    typingComplete && !questionFaded
                      ? `${fadeOut} 1s ease-out 0.8s forwards`
                      : "none",
                }}
              >
                <Typography
                ...
                >
                  ...
                  >
                    <MobileTypingText>What Does AI Think</MobileTypingText>
                  </Box>
          ...
          <Slide direction="up" in={showObservation} timeout={1000}>
            <StatsCard
              ...
              sx={{
                mb: 4,
                background:
                  "linear-gradient(135deg, rgba(153, 102, 255, 0.2), rgba(255, 107, 139, 0.2))",
              ...
              <CardContent sx={{ p: { xs: 2, md: 3 }, textAlign: "center" }}>
                ...
                <Typography
                  ...
                  sx={{
                    ...
                    color: (theme) =>
                      theme.palette.mode === "dark" ? "#9966ff" : "#e2c9c9",
                  }}
                >
                  AI Observations
                </Typography>
                ...
                >
                  "There's emotional effort, but unmet needs beneath the
                  surface."
                </Typography>
              </CardContent>
            </StatsCard>
              ...
              >
                {isAuthenticated ? (
                  <>
                    ...
                    >
                      Developing emotional intelligence takes practice. Let's
                      continue exploring your relationship patterns together.
                    </Box>
                  </>
                ) : (
                ...
                >
                  <Button
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        background:
                          "linear-gradient(90deg, #ff5c7f 0%, #2bc0b2 100%)",
                        transform: "translateY(-2px)",
            ...
            <Grid container spacing={4}>
              <Grid item xs={12} md={6} lg={3}>
                ...
                >
                  ...
                  <CardContent sx={{ textAlign: "center", py: 4, px: 3 }}>
                    <PeopleIcon
                      sx={{ fontSize: 60, color: "#ff6b8b", mb: 2 }}
                    />
                    <Typography
                      gutterBottom
                      variant="h5"
                      component="div"
                      sx={{ fontWeight: 600, mb: 2, fontSize: "1.4rem" }}
                    >
                    ...
                    >
                      Add the important people in your life and track your
                      interactions, emotions, and experiences with them. Build a
                      comprehensive view of each relationship.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} md={6} lg={3}>
                ...
                >
                  ...
                  <CardContent sx={{ textAlign: "center", py: 4, px: 3 }}>
                    <PsychologyIcon
                      sx={{ fontSize: 60, color: "#9966ff", mb: 2 }}
                    />
                    <Typography
                      gutterBottom
                      variant="h5"
                    ...
                    <Typography
                      ...
                      sx={{ lineHeight: 1.6, fontSize: "0.95rem" }}
                    >
                      Have natural conversations with our emotionally
                      intelligent AI to process your thoughts and feelings about
                      each relationship. Get insights in real-time.
                    </Typography>
                  </CardContent>
                </Card>
              </Grid>
              ...
              <Grid item xs={12} md={6} lg={3}>
                ...
                >
                  ...
                  <CardContent sx={{ textAlign: "center", py: 4, px: 3 }}>
                    <InsightsIcon
                      sx={{ fontSize: 60, color: "#33d2c3", mb: 2 }}
                    />
                    <Typography
                      gutterBottom
                      variant="h5"
                    ...
                    <Typography
                      ...
                      sx={{ lineHeight: 1.6, fontSize: "0.95rem" }}
                    >
                      Discover patterns, improve self-awareness, and develop
                      strategies for deeper connections with the people who
                ...
                >
                  ...
                  <CardContent sx={{ textAlign: "center", py: 4, px: 3 }}>
                    ...
                    <Typography
                      ...
                      sx={{ lineHeight: 1.6, fontSize: "0.95rem" }}
                    >
                      Upload your WhatsApp conversations and let SoulSync decode
                      tone, trends, and emotional cues in your relationships.
                      Private and secure.
                    </Typography>
                  </CardContent>
                </Card>
          ...
          >
            ...
            <Box>
              ...
              <Typography variant="body1" sx={{ mb: 2 }}>
                Your data is never shared. Everything is analyzed locally and
                securely, with full transparency. We never store your chat data
                longer than needed for analysis.
              </Typography>
              <Typography variant="body2" sx={{ opacity: 0.8 }}>
                SoulSync uses state-of-the-art encryption and doesn't share your
                relationship data with third parties.
              </Typography>
            </Box>
          </Box>
        </Container>
        ...
        {!isAuthenticated && (
          ...
          >
            <Container maxWidth="md">
              ...
              >
                Join thousands of people using SoulSync to gain insights,
                improve communication, and build stronger connections with the
        ...
        {isAuthenticated && (
          ...
          >
            <Container maxWidth="md">
              ...
              >
                Access your dashboard to view your relationships, start new
                conversations, or analyze your recent interactions.
              </Typography>
