    ...
    return (
      <Container maxWidth="md">
        ...
        >
          ...
          <Typography sx={{ mb: 3 }}>
            {error ||
              "Could not find relationship data. Please try again later."}
          </Typography>
          <Button
            variant="contained"
            color="primary"
      ...
      <AnimatedBox>
        ...
        >
          ...
          <Typography paragraph>
            Ask the AI any questions about your relationship with{" "}
            {relationship.contactName}. The AI will analyze your relationship
            data and provide thoughtful insights.
          </Typography>
          <Typography paragraph>
            You can ask questions by text or voice. The AI will use your
            conversation history, relationship details, and patterns to provide
