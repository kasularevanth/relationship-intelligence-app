      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[0] }}>
                {analysis.metrics?.emotionalHealthScore || "N/A"}
              </span>
            </MetricValue>
          </div>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[1] }}>
                {analysis.metrics?.conflictFrequency || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[2] }}>
                {analysis.metrics?.attachmentStyle || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[3] }}>
                {analysis.metrics?.affectionLogisticsRatio || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[4] }}>
                {analysis.metrics?.intimacyLevel || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: romanticColors[5] }}>
                {analysis.metrics?.conflictResolutionPattern || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[0] }}>
                {analysis.metrics?.initiationBalance || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[1] }}>
                {analysis.metrics?.humorDepthRatio || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[2] }}>
                {analysis.metrics?.vulnerabilityIndex || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[3] }}>
                {analysis.metrics?.longestGap || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[4] }}>
                {analysis.metrics?.topicDiversity || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: friendshipColors[5] }}>
                {analysis.metrics?.engagementConsistency || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[0] }}>
                {analysis.metrics?.professionalTone || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[1] }}>
                {analysis.metrics?.powerDynamic || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[2] }}>
                {analysis.metrics?.responseTime || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[3] }}>
                {analysis.metrics?.taskSocialRatio || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[4] }}>
                {analysis.metrics?.clarityIndex || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: professionalColors[5] }}>
                {analysis.metrics?.boundaryMaintenance || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[0] }}>
                {analysis.metrics?.familyPattern || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[1] }}>
                {analysis.metrics?.emotionalWarmth || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[2] }}>
                {analysis.metrics?.familyRole || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[3] }}>
                {analysis.metrics?.interactionFrequency || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[4] }}>
                {analysis.metrics?.generationGap || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            <MetricLabel darkMode={darkMode}>
              Traditional vs. Modern
            </MetricLabel>
            <MetricValue darkMode={darkMode}>
              <span style={{ color: familyColors[5] }}>
                {analysis.metrics?.traditionAutonomyBalance || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[0] }}>
                {analysis.metrics?.guidanceStyle || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[1] }}>
                {analysis.metrics?.feedbackBalance || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[2] }}>
                {analysis.metrics?.growthFocus || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[3] }}>
                {analysis.metrics?.followThrough || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[4] }}>
                {analysis.metrics?.knowledgeTransfer || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: mentorColors[5] }}>
                {analysis.metrics?.goalSetting || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
      ...
      <MetricsGrid>
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: relationshipColor }}>
          ...
          <MetricFooter darkMode={darkMode}>
            <span>
              Across {analysis.conversationCount || "multiple"} conversations
            </span>
          </MetricFooter>
        </MetricCard>
        ...
        <MetricCard darkMode={darkMode}>
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span
                style={{
                  color: analysis.metrics?.sentimentLabel?.includes("positive")
                    ? "#10b981"
          ...
          <MetricFooter darkMode={darkMode}>
            <span>
              Score: {Math.round((analysis.metrics?.sentimentScore || 0) * 100)}
              %
            </span>
          </MetricFooter>
        </MetricCard>
          ...
          <div style={{ marginBottom: "0.5rem" }}>
            ...
            <MetricValue darkMode={darkMode}>
              <span style={{ color: "#60a5fa" }}>
                {analysis.metrics?.averageResponseTime || "N/A"}
              </span>
            </MetricValue>
          </div>
          <MetricFooter darkMode={darkMode}>
