    ...
    >
      ...
      <Box
        ...
        sx={{
          ...
          cursor: "pointer",
          background:
            "radial-gradient(circle, rgba(137,207,240,1) 0%, rgba(0,119,255,1) 100%)",
          ...
          [`&.${getAnimationClass()}`]: {
            animation:
              status === "listening"
                ...
                : status === "processing"
                ? "pulse-orange 0.8s infinite"
                : status === "speaking"
                ? "pulse-normal 2s infinite"
                : "none",
          },
      ...
      >
        ...
        <Box
          sx={{
            ...
            animation:
              status !== "idle"
                ? "glow-animation 2s infinite alternate"
                : "none",
          }}
        />
      ...
      <style jsx="true">{`
        @keyframes pulse-blue {
          0% {
            transform: scale(1);
            box-shadow: 0 0 30px 5px rgba(0, 119, 255, 0.4);
          }
          50% {
            transform: scale(1.05);
            box-shadow: 0 0 40px 10px rgba(0, 119, 255, 0.6);
          }
          100% {
            transform: scale(1);
            box-shadow: 0 0 30px 5px rgba(0, 119, 255, 0.4);
        ...
        @keyframes pulse-orange {
          0% {
            transform: scale(1);
            box-shadow: 0 0 30px 5px rgba(237, 137, 54, 0.4);
          }
          50% {
            transform: scale(1.03);
            box-shadow: 0 0 35px 8px rgba(237, 137, 54, 0.5);
          }
          100% {
            transform: scale(1);
            box-shadow: 0 0 30px 5px rgba(237, 137, 54, 0.4);
