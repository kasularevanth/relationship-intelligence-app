...
const CloseButton = styled.button`
  ...
  border-radius: 50%;
  background: ${(props) =>
    props.darkMode ? "rgba(31, 41, 55, 0.7)" : "rgba(249, 250, 251, 0.8)"};
  backdrop-filter: blur(4px);
  border: 1px solid
    ${(props) =>
      props.darkMode ? "rgba(75, 85, 99, 0.3)" : "rgba(229, 231, 235, 0.7)"};
  ...
  &:hover {
    background: ${(props) =>
      props.darkMode ? "rgba(55, 65, 81, 0.9)" : "rgba(243, 244, 246, 0.9)"};
...
const FeatureIconWrapper = styled.div`
  ...
  background: ${(props) =>
    props.darkMode ? "rgba(31, 41, 55, 0.4)" : "rgba(243, 244, 246, 0.7)"};
  ...
  border: 1px solid
    ${(props) =>
      props.darkMode ? "rgba(75, 85, 99, 0.2)" : "rgba(229, 231, 235, 0.8)"};
          ...
          <ContentWrapper>
            ...
            <HighlightTextWrapper>
              {highlightTexts.map((text, index) => (
                <HighlightText key={index} active={index === highlightedText}>
                  {text}
                </HighlightText>
              ))}
            </HighlightTextWrapper>
            ...
            <MainContent>
              ...
              <LeftSection>
                <BannerTitle darkMode={darkMode}>
                  Unlock the full potential of your relationship with{" "}
                  {relationshipName}
                </BannerTitle>

                <FeaturesGrid>
                  {features.map((feature, index) => (
                    <FeatureItem key={index} active={index === activeFeature}>
                      <FeatureIconWrapper
                        color={feature.color}
                        darkMode={darkMode}
