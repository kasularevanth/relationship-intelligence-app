...
const Card = styled.div`
  ...
  border: 1px solid
    ${(props) =>
      props.darkMode ? "rgba(255, 255, 255, 0.05)" : "rgba(99, 102, 241, 0.1)"};
`;
...
const CloseButton = styled.button`
  ...
  border-radius: 50%;
  background: ${(props) =>
    props.darkMode ? "rgba(255, 255, 255, 0.1)" : "rgba(99, 102, 241, 0.1)"};
  border: none;
  display: flex;
  align-items: center;
  ...
  &:hover {
    background: ${(props) =>
      props.darkMode ? "rgba(255, 255, 255, 0.2)" : "rgba(99, 102, 241, 0.2)"};
  }
...
const SlideContainer = styled.div`
  position: relative;
  background: ${(props) =>
    props.darkMode ? "rgba(30, 41, 59, 0.5)" : "rgba(243, 244, 246, 0.5)"};
  ...
  border: 1px solid
    ${(props) =>
      props.darkMode ? "rgba(99, 102, 241, 0.2)" : "rgba(99, 102, 241, 0.1)"};
`;
...
const Slide = styled.div`
  ...
  transform: ${(props) =>
    props.active ? "translateX(0)" : "translateX(20px)"};
  transition: opacity 0.5s ease, transform 0.5s ease;
...
const CtaIconWrapper = styled.div`
  ...
  margin-bottom: 16px;
  background: ${(props) =>
    props.darkMode ? "rgba(99, 102, 241, 0.2)" : "rgba(224, 231, 255, 0.7)"};
  color: ${(props) => (props.darkMode ? "#818cf8" : "#6366f1")};
...
const FooterText = styled.p`
  ...
  margin: 16px 0 0 0;
  color: ${(props) =>
    props.darkMode ? "rgba(203, 213, 225, 0.6)" : "rgba(107, 114, 128, 0.7)"};
`;

const AnimatedInsightsPrompt = ({
  relationshipId,
  contactName,
  relationshipType,
  onImportClick,
    ...
    const defaults = [
      {
        ...
        description:
          "Uncover your unique conversation patterns and communication style",
        icon: <MessageCircle size={24} />,
      },
      {
        title: "Topic Distribution",
        description:
          "See what you talk about most and why it matters to your relationship",
        icon: <PieChart size={24} />,
      },
      {
        title: "Relationship Health",
        description:
          "Track the evolution of your connection over time with AI insights",
        ...
        <Content>
          ...
          <LeftColumn>
            ...
            <SlideContainer darkMode={darkMode}>
              ...
              {slides.map((slide, index) => (
                <Slide key={index} active={currentSlide === index}>
                  <SlideIcon darkMode={darkMode}>{slide.icon}</SlideIcon>
                  <SlideContent>
            ...
            <FooterText darkMode={darkMode}>
              Chat analysis reveals patterns that enhance understanding and
          ...
          <RightColumn>
            <CtaSection>
              ...
              <CtaDescription darkMode={darkMode}>
                Import your chat history to unlock all insights about{" "}
                {contactName}
              </CtaDescription>
