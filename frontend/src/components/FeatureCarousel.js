...
const FeatureCarousel = () => {
  ...
  const slides = [
    {
      ...
      description:
        "Your AI-powered relationship advisor. Understand emotional patterns and improve how you connect with those who matter.",
      color: "#5e35b1", // Deep purple
      icon: (
        <FavoriteIcon sx={{ fontSize: isMobile ? 36 : 50, color: "#ff4081" }} />
      ),
      illustration: (
    ...
    },
    {
      ...
      description:
        "Your data is never shared. Everything is analyzed locally and securely, with full transparency.",
      color: "#2e7d32", // Green
    ...
    },
    {
      ...
      description:
        "Receive helpful insights to navigate conflict, deepen bonds, and grow mutual understanding — powered by AI.",
      color: "#ed6c02", // Orange
      icon: (
        <SmartToyOutlinedIcon
          sx={{ fontSize: isMobile ? 36 : 50, color: "#fff" }}
        />
      ),
      illustration: (
        <Lottie
    ...
    },
    {
      ...
      description:
        "Upload your WhatsApp conversations and let SoulSync decode tone, trends, and emotional cues in your relationships.",
      color: "#0288d1", // Blue
      icon: (
        <ChatOutlinedIcon
          sx={{ fontSize: isMobile ? 36 : 50, color: "#fff" }}
  ...
  return (
    <CarouselContainer>
      <SlideContainer sx={{ transform: `translateX(-${currentSlide * 100}%)` }}>
        {slides.map((slide, index) => (
          ...
          >
            ...
            <IllustrationBox>{slide.illustration}</IllustrationBox>
            ...
            <GradientButton component={RouterLink} to="/register">
              Get Started
            </GradientButton>
          </Slide>
        ))}
