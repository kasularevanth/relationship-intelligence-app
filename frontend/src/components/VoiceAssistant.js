...
const AnimatedCircle = styled(Box)(
  ({ theme, size, delay, duration, isAnimating }) => ({
    position: "absolute",
    width: size,
    height: size,
    borderRadius: "50%",
...
const CoreOrb = styled(Box)(({ theme, isAnimating }) => ({
  ...
  borderRadius: "50%",
  background:
    "radial-gradient(circle, rgba(57,255,20,1) 0%, rgba(57,255,20,0.3) 70%, rgba(57,255,20,0) 100%)",
...
const EnergyParticle = styled(Box)(
  ({ theme, angle, distance, size, isAnimating, delay }) => ({
    position: "absolute",
    width: size,
    height: size,
    borderRadius: "50%",
