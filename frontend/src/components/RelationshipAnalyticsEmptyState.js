    ...
    switch (relationshipType?.toLowerCase()) {
      ...
      case "partner":
        return {
          ...
          subtitle:
            "Reveal emotional patterns, communication balance, attachment styles, and personalized recommendations.",
        };
      case "friendship":
      case "friend":
        return {
          ...
          subtitle:
            "Uncover interaction patterns, humor vs depth balance, shared interests, and friendship growth opportunities.",
        };
      case "professional":
      case "colleague":
        return {
          ...
          subtitle:
            "Reveal communication effectiveness, response patterns, task focus, and professional development insights.",
        };
      case "family":
        return {
          title: "Understand Family Connection Patterns",
          subtitle:
            "Explore communication styles, emotional warmth, support networks, and family relationship insights.",
        };
      default:
        return {
          title: `Unlock ${contactName} Relationship Analytics`,
          subtitle:
            "Import your chat history to reveal personalized insights, communication patterns, and recommendations.",
        };
    }
  };
    ...
    <div style={{ width: "100%", position: "relative", overflow: "hidden" }}>
      ...
      >
        <div
          style={{
            background:
              relationshipType?.toLowerCase() === "romantic" ||
              relationshipType?.toLowerCase() === "partner"
                ? "linear-gradient(to bottom right, #f43f5e, #ef4444)"
                : relationshipType?.toLowerCase() === "friendship" ||
                  relationshipType?.toLowerCase() === "friend"
                ? "linear-gradient(to bottom right, #3b82f6, #6366f1)"
                : relationshipType?.toLowerCase() === "professional" ||
                  relationshipType?.toLowerCase() === "colleague"
                ? "linear-gradient(to bottom right, #14b8a6, #10b981)"
                : relationshipType?.toLowerCase() === "family"
                ? "linear-gradient(to bottom right, #f59e0b, #eab308)"
      ...
      <div className="absolute -bottom-4 left-1/2 transform -translate-x-1/2 animate-bounce hidden md:block">
        <div
          className={`w-8 h-8 rounded-full flex items-center justify-center bg-white dark:bg-gray-900 shadow-md`}
        >
