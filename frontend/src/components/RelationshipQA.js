...
const RelationshipQA = ({
  ...
  const generatePDF = async () => {
    try {
      ...
      doc.text(
        questionsText,
        pageWidth - margin - questionsTextWidth,
        yPosition
      );
  ...
  const generateJSON = async () => {
    ...
    a.href = url;
    a.download = `${relationshipName.replace(
      /\s+/g,
      "_"
    )}_conversation_history.json`;
    ...
    <Box sx={{ mt: 4, mb: 6 }}>
      <Paper elevation={3} sx={{ p: 3, borderRadius: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary" paragraph>
          Ask questions to gain insights about your relationship. The AI will
          analyze your relationship data to provide thoughtful perspectives.
        </Typography>
        ...
        <DialogContent>
          {downloadComplete ? (
              ...
              <CircleProgressContainer>
                ...
                <CircleProgressLabel>
                  <Typography
                    ...
                    sx={{
                      background:
                        "linear-gradient(135deg, #ff6b8b 0%, #33d2c3 100%)",
            ...
            <>
              ...
              >
                Choose format for your <strong>{relationshipName}</strong>{" "}
                ...
                >
                  <PictureAsPdfIcon
                    sx={{
                      fontSize: 40,
                      color:
                        downloadFormat === "pdf" ? "#ff6b8b" : "text.secondary",
                      mb: 1,
                    }}
                  />
